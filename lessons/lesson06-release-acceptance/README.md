...
配套发布流程模型位于[`models/`](models/)，版本演化证据位于[`teacher-artifacts/`](teacher-artifacts/)，学生提交模板位于[`student-templates/`](student-templates/)。发布时同时使用[追溯矩阵](AC-01至AC-12追溯矩阵.md)和[发布检查表](发布检查表.md)。
